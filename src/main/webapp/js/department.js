function departmentupdate(row){
    ...
    var str = ' <form id="ff" method="post">\n' +
        ...
        '            <tr>\n' +
        '                <td>单位领导</td>\n' +
        '                <td><input type="text" id="d_manager" name="d_manager" /> <input type="hidden" id="id" name="id" /></td>\n' +
        '            </tr>\n' +
        '        </table>\n' +
        '    </form>';
    //把表单添加到对话框中
...
function departmentinsert(){
    ...
    var str = ' <form id="ff" method="post">\n' +
        ...
        '            <tr>\n' +
        '                <td>单位领导</td>\n' +
        '                <td><input type="text" id="d_manager" name="d_manager" /> </td>\n' +
        '            </tr>\n' +
        '        </table>\n' +
        '    </form>';
    //把表单添加到对话框中
